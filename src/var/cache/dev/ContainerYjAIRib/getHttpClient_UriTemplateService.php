...
class getHttpClient_UriTemplateService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/vendor/symfony/http-client/DecoratorTrait.php';
        include_once \dirname(__DIR__, 5).'/vendor/symfony/http-client/UriTemplateHttpClient.php';
