...
class getConsole_Command_TranslationPullService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/vendor/symfony/translation/Command/TranslationTrait.php';
        include_once \dirname(__DIR__, 5).'/vendor/symfony/translation/Command/TranslationPullCommand.php';
