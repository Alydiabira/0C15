...
class getAssetMapper_Importmap_ResolverService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 5).'/vendor/symfony/asset-mapper/ImportMap/Resolver/PackageResolverInterface.php';
        include_once \dirname(__DIR__, 5).'/vendor/symfony/asset-mapper/ImportMap/Resolver/JsDelivrEsmResolver.php';
