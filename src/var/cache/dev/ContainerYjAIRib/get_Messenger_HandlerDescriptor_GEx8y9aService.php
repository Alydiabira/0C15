...
class get_Messenger_HandlerDescriptor_GEx8y9aService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/vendor/symfony/notifier/Transport/TransportInterface.php';
        include_once \dirname(__DIR__, 5).'/vendor/symfony/notifier/Transport/Transports.php';
        include_once \dirname(__DIR__, 5).'/vendor/symfony/notifier/Transport.php';
