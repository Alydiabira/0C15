...
class getAssetMapper_Importmap_Command_AuditService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/vendor/symfony/asset-mapper/Command/ImportMapAuditCommand.php';
        include_once \dirname(__DIR__, 5).'/vendor/symfony/asset-mapper/ImportMap/ImportMapAuditor.php';
