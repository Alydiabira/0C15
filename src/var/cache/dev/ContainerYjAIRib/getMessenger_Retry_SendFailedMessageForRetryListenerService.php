...
class getMessenger_Retry_SendFailedMessageForRetryListenerService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 5).'/vendor/symfony/messenger/EventListener/SendFailedMessageForRetryListener.php';
        ...
        $instance = new \Symfony\Component\Messenger\EventListener\SendFailedMessageForRetryListener($b, $b, ($container->privates['logger'] ?? self::getLoggerService($container)), $a);
