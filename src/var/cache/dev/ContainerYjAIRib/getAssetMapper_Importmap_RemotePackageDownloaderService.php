...
class getAssetMapper_Importmap_RemotePackageDownloaderService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 5).'/vendor/symfony/asset-mapper/ImportMap/RemotePackageDownloader.php';
        include_once \dirname(__DIR__, 5).'/vendor/symfony/asset-mapper/ImportMap/RemotePackageStorage.php';
