...
class __TwigTemplate_5c0634d780a80f4cdb0ac53c14d99d91 extends Template
{
...
";
    ...
    {
        return array (  94 => 11,  89 => 9,  85 => 8,  80 => 6,  76 => 4,  63 => 3,  40 => 1,);
    }
...
{% block admin %}
    <div class=\"d-flex justify-content-between align-items-center\">
        <h1>Albums</h1>
        <a href=\"{{ path(\x27admin_album_index\x27) }}\" class=\"btn btn-primary\">Retour</a>
    </div>
    {{ form_start(form) }}
        {{ form_row(form.name) }}
        <button type=\"submit\" class=\"btn btn-primary\">Ajouter</button>
