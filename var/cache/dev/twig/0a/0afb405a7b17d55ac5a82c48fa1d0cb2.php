...
class __TwigTemplate_cd4666e96d60402bff25c162647dce40 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("admin.html.twig", "admin/media/add.html.twig", 1);
    ...
    ";
        ...
        ";
        // line 9
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 9, $this->source); })()), "user", [], "any", false, false, false, 9), 'row');
        yield "
        ";
        // line 10
        if ($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_ADMIN")) {
            // line 11
            yield "            ";
            yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 11, $this->source); })()), "album", [], "any", false, false, false, 11), 'row');
            yield "
            ";
            // line 12
            yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 12, $this->source); })()), "title", [], "any", false, false, false, 12), 'row');
            yield "
        ";
        }
        // line 14
        yield "        ";
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 14, $this->source); })()), "file", [], "any", false, false, false, 14), 'row');
        yield "
...
";
    ...
    {
        return array (  104 => 16,  98 => 14,  93 => 12,  88 => 11,  86 => 10,  82 => 9,  78 => 8,  73 => 6,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{% block admin %}
    ...
    {{ form_start(form) }}
        ...
        <button type=\"submit\" class=\"btn btn-primary\">Ajouter</button>
    {{ form_end(form) }}
{% endblock %}", "admin/media/add.html.twig", "/Users/diabiraaly/Desktop/Bureau - MacBook Air de DIABIRA/Openclassrooms/0C15/templates/admin/media/add.html.twig");
    }
}
