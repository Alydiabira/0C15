...
class __TwigTemplate_6978208fc64d266006a873d1a8a753b8 extends Template
{
...
";
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        yield "                    <form method=\"post\">
                        <div class=\"mb-3\">
                            <label for=\"username\" class=\"form-label\">Nom d\x27utilisateur</label>
...
";
    ...
    {
        return array (  179 => 34,  165 => 35,  163 => 34,  149 => 23,  144 => 20,  138 => 18,  136 => 17,  129 => 12,  116 => 11,  104 => 8,  91 => 7,  79 => 4,  66 => 3,  43 => 1,);
    }
        ...
        <div class=\"row min-vh-100 align-items-center justify-content-center\">
            <nav class=\"col-md-6 col-lg-4\">
                <div class=\"position-sticky\">
                    <h1 class=\"text-white\">Connexion</h1>
                    {% if error %}
                        <div class=\"alert alert-danger\" role=\"alert\">{{ error.messageKey|trans(error.messageData, \x27security\x27) }}</div>
                    {% endif %}
                    <form method=\"post\">
                        <div class=\"mb-3\">
                            <label for=\"username\" class=\"form-label\">Nom d\x27utilisateur</label>
...
{% endblock %}", "admin/login.html.twig", "/Users/diabiraaly/Desktop/Bureau - MacBook Air de DIABIRA/Openclassrooms/0C15/templates/admin/login.html.twig");
    }
}
